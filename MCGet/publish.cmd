...
dotnet publish -c Release -f net8.0 -r win-x86 -t:CreateZip,Clean -p:PublishTrimmed=true -p:PublishSingleFile=true
dotnet publish -c Release -f net8.0 -r win-x64 -t:CreateZip,Clean -p:PublishTrimmed=true -p:PublishSingleFile=true

dotnet publish -c Release -f net8.0 -r osx-x64 -t:CreateZip,Clean -p:PublishTrimmed=true -p:PublishSingleFile=true